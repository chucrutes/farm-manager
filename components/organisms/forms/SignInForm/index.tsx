...
const SignInForm = () => {
	...
	return (
		<div>
            ...
            {errors.user && <Alert icon={<ErrorIcon/>} severity="error" />}
					</LabeledInput>
					<LabeledInput>
						<Label htmlFor={passwordTagId}>Senha</Label>
						<Input label="Usuário" id={passwordTagId} {...register("password")} />
            {errors.password && <Alert icon={<ErrorIcon/>} severity="error" />}
					</LabeledInput>
					<div>
